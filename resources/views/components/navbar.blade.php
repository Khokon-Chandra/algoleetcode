<nav class="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8 flex justify-between items-center">
    <ul class="flex items-center gap-4">
        ...
        <li class="hidden md:flex"><a class="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3" href="#">Explore</a></li>
        <li class="hidden md:flex"><a class="active text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3" href="#">Problems</a></li>
        <li class="hidden md:flex"><a class="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3" href="#">Contest</a></li>
        <li class="hidden md:flex"><a class="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3" href="#">Discuss</a></li>
    </ul>
    ...
    <ul class="flex md:hidden items-center justify-center">
        <li class="text-xl text-gray-600 dark:text-gray-300 py-3">
