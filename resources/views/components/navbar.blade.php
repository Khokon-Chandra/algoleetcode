<nav class="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8 flex justify-between items-center">
    <ul class="flex items-center gap-4">
        <li class="hidden dark:flex h-[22px]"><svg width="95" height="111" viewBox="0 0 95 111" fill="none"
        ...
        <li class="flex dark:hidden h-[22px]"><svg width="95" height="111" viewBox="0 0 95 111" fill="none"
                xmlns="http://www.w3.org/2000/svg" class="h-full w-auto max-w-none">
                <path
                    d="M68.0063 83.0664C70.5 80.5764 74.5366 80.5829 77.0223 83.0809C79.508 85.579 79.5015 89.6226 77.0078 92.1127L65.9346 103.17C55.7187 113.371 39.06 113.519 28.6718 103.513C28.6117 103.456 23.9861 98.9201 8.72653 83.957C-1.42528 74.0029 -2.43665 58.0749 7.11648 47.8464L24.9282 28.7745C34.4095 18.6219 51.887 17.5122 62.7275 26.2789L78.9048 39.362C81.6444 41.5776 82.0723 45.5985 79.8606 48.3429C77.6488 51.0873 73.635 51.5159 70.8954 49.3003L54.7182 36.2173C49.0488 31.6325 39.1314 32.2622 34.2394 37.5006L16.4274 56.5727C11.7767 61.5522 12.2861 69.574 17.6456 74.8292C28.851 85.8169 37.4869 94.2846 37.4969 94.2942C42.8977 99.496 51.6304 99.4184 56.9331 94.1234L68.0063 83.0664Z"
                    fill="#FFA116"></path>
        ...
        <li class="hidden md:flex"><a
                ...
                href="#">Explore</a></li>
        <li class="hidden md:flex"><a
                class="active text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3"
                href="#">Problems</a></li>
        <li class="hidden md:flex"><a
                class="text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-gray-100 py-3"
                href="#">Contest</a></li>
    ...
    @else
        <div class="gap-4 hidden md:flex items-center">
            <a href="{{ route('register') }}"
                class="text-gray-700 text-md hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">Register</a>
            <span class="text-gray-700 text-sm font-thin dark:text-gray-300 ">or</span>
            <a href="{{ route('login') }}"
                class="text-gray-700 text-md hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100">Sign in</a>
...
<nav id="mobileMenu"
    ...
    <div class="border-b border-gray-300 dark:border-gray-600 flex justify-between items-center px-6 py-4">
        ...
        @guest
            <div class="space-x-4">
                <a class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 cursor-pointer"
        ...
        @auth
            <li>
                <form method="POST" action="{{ route('logout') }}"
                    ...
                    @csrf
                    <button class="w-full flex gap-4 items-center">
