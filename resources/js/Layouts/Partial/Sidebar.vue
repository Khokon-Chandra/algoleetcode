            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <SidebarLink :href="route('admin.problems.index')"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Problem</span>
                    </SidebarLink>
                </li>
                <li>
                    <SidebarLink :href="route('admin.tags.index')" :active="route().current('admin.tags.index')"
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Study Plan</span>
                    </a>
                </li>
