                ...
                <div class="px-3 py-3 lg:px-5 lg:pl-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start rtl:justify-end">
                            ...
                            <Link :href="route('problems.index')" class="flex items-center gap-3  ms-2 md:me-24">
                            <AppLogo />
                            <span
                                class="self-center text-     font-semibold sm:text-2xl whitespace-nowrap dark:text-white">LeetCode</span>
                            </Link>
                        </div>
