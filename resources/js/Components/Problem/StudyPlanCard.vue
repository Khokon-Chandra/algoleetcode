...
<template>
    <Link href="#"
        class="p-2 rounded-lg border border-gray-200 dark:border-gray-800 dark:bg-gray-700 flex gap-4 shadow-sm hover:shadow-2xl transition duration-200 ease-linear">
