...
const submitForm = () => {
    router.post(route('admin.tags.store'), { name: name.value }, {
        preserveState: true,
        onError: (error) => {
            errors.name = error.name;
        },
        onSuccess: (data) => {
            const $targetEl = document.getElementById('create-tag-modal');
...
<template>
    ...
    <!-- Main modal -->
    <div id="create-tag-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="create-tag-modal">
